...
impl BindGroup {
    pub(crate) fn new_compute_texture(
        device: &wgpu::Device,
        input_textures: &[&wgpu::TextureView],
        output_textures: &[&wgpu::TextureView],
    ) -> Self {
        let mut layout_entries = vec![];
        let mut binding = 0;
        for _ in input_textures {
